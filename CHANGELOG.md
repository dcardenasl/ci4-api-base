...
- Updated package name placeholders in documentation
- Corrected namespace references from `YourVendor` to `dcardenasl`
- Fixed GitHub repository URLs in README and INSTALLATION files
...
[1.0.1]: https://github.com/dcardenasl/ci4-api-base/releases/tag/v1.0.1
